...
<head>
    ...
    <link href="${fy}/assets/weather/css/weather-icons.css" rel="stylesheet"/>
    <link href="${fy}/assets/calendar/fullcalendar.css" rel="stylesheet"/>

    <link href="${fy}/assets/css/charts/chartist.min.css" rel="stylesheet">
    <link href="${fy}/assets/css/lib/vector-map/jqvmap.min.css" rel="stylesheet">
                                ...
                                <div class="table-stats order-table ov-h">
                                    <table class="table ">
                                        ...
                                        <tr>
                                            ...
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="${fy}/images/avatar/1.jpg"
                                                                     alt=""></a>
                                                </div>
                                            </td>
                                            <td> #5469</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="${fy}/images/avatar/2.jpg"
                                                                     alt=""></a>
                                                </div>
                                            </td>
                                            <td> #5468</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="${fy}/images/avatar/3.jpg"
                                                                     alt=""></a>
                                                </div>
                                            </td>
                                            <td> #5467</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="${fy}/images/avatar/4.jpg"
                                                                     alt=""></a>
                                                </div>
                                            </td>
                                            <td> #5466</td>
                                        ...
                                        <tr class=" pb-0">
                                            ...
                                            <td class="avatar pb-0">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="${fy}/images/avatar/6.jpg"
                                                                     alt=""></a>
                                                </div>
                                            </td>
                                            <td> #5465</td>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="msg-received msg-container">
                                                <div class="avatar">
                                                    <img src="${fy}/images/avatar/64-1.jpg" alt="">
                                        ...
                                        <li>
                                            <div class="msg-sent msg-container">
                                                <div class="avatar">
                                                    <img src="${fy}/images/avatar/64-2.jpg" alt="">
                                                    <div class="send-time">11.11 am</div>
                                                </div>
                                                <div class="msg-box">
                                                    <div class="inner-box">
...
<script src="${fy}/assets/js/plugins.js"></script>
<script src="${fy}/assets/js/main.js"></script>
<script src="${fy}/assets/js/lib/chart-js/Chart.bundle.js"></script>

<script src="${fy}/assets/js/lib/chartist/chartist.min.js"></script>
<script src="${fy}/assets/js/lib/chartist/chartist-plugin-legend.js"></script>
<script src="${fy}/assets/js/lib/flot-chart/jquery.flot.js"></script>
<script src="${fy}/assets/js/lib/flot-chart/jquery.flot.pie.js"></script>
<script src="${fy}/assets/js/lib/flot-chart/jquery.flot.spline.js"></script>
<script src="${fy}/assets/weather/js/jquery.simpleWeather.min.js"></script>
<script src="${fy}/assets/weather/js/weather-init.js"></script>
<script src="${fy}/assets/js/lib/moment/moment.js"></script>
<script src="${fy}/assets/calendar/fullcalendar.min.js"></script>
<script src="${fy}/assets/calendar/fullcalendar-init.js"></script>

<script src="${fy}/assets/js/init/weather-init.js"></script>

<script src="${fy}/assets/js/init/fullcalendar-init.js"></script>
